                    ...
                    <form action="#" method="post">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="KodePenerimaanBarang" readonly="readonly" value="{{$penerimaanbarangreturn->KodePenerimaanBarang}}" id="inputBerlaku">
                                </div>
                                <div class="form-group">
                                    <label for="inputDate">Tanggal</label>
                                    <input type="date" class="form-control" name="Tanggal" id="inputDate" readonly="readonly" value="{{$penerimaanbarangreturn->Tanggal}}">
                                </div>
                            </div>
                            <!-- pembatas -->
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" readonly="readonly" class="diskon form-control diskon" name="diskon" id="inputBerlaku" value="{{$penerimaanbarangreturn->Diskon}}">
                                </div>
                                <div class="form-group">
                                    <label for="inputPelanggan">PPN</label>
                                    <input type="text" readonly="readonly" class="diskon form-control ppn" name="ppn" id="inputBerlaku" value="{{$penerimaanbarangreturn->PPN}}">
                                </div>
                            </div>
                            <!-- pembatas -->
                            <div class="form-group col-md-1"></div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="col-md-9">
                                    @if($OPN == true)
                                    <button type="submit" class="btn btn-success" formaction="{{ url('/returnPenerimaanBarang/confirm/'.$id) }}">Konfirmasi</button>
                                    <button type="submit" class="btn btn-danger" formaction="{{ url('/returnPenerimaanBarang/cancel/'.$id) }}">Batal</button>
                                    @endif
                                    @if($OPN == false)
                                    <button type="submit" class="btn btn-primary" formaction="{{ url('/returnPenerimaanBarang/print/'.$id) }}"></button>
                                    @endif
                                </div>
                                <div class="col-md-3">
                                    <label for="inputPelanggan">PPN</label>
